...
const defaultClass =
  "grid h-10 w-10 place-items-center rounded-xl border border-plum-200 text-plum-700 transition duration-200 hover:bg-plum-50 focus:outline-none focus-visible:ring-4 focus-visible:ring-plum-300/40 dark:border-white/15 dark:text-gray-200 dark:hover:bg-white/5";
