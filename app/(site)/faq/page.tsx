...
export default function FaqPage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 md:py-20 lg:px-8">
          <nav className="hero-anim text-sm text-plum-500" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2">
              ...
              <li className="font-medium text-plum-700" aria-current="page">FAQ</li>
            </ol>
          </nav>
      ...
      {/* BOOKING & VISITING */}
      <section id="booking-faqs" className="bg-plum-50 py-20 md:py-24">
        <div className="mx-auto max-w-3xl px-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col gap-4">
            <FaqItem question="Do I need to book, or can I walk in?" defaultOpen>
              Walk-ins are warmly welcome whenever we have space. To be sure of your preferred time, a quick call to <a href={`tel:${site.phoneTel}`} className="font-semibold text-plum-700 underline decoration-plum-300 underline-offset-2 hover:text-plum-900">{site.phoneDisplay}</a> is the surest way to reserve a spot.
            </FaqItem>
            <FaqItem question="Where are you located?">
              We're at 3/459 Nepean Hwy, Frankston VIC 3199 — easy to reach on the Mornington Peninsula, with parking close by. You can <a href={site.maps} target="_blank" rel="noopener" className="font-semibold text-plum-700 underline decoration-plum-300 underline-offset-2 hover:text-plum-900">get directions here</a>.
            </FaqItem>
      ...
      {/* YOUR TREATMENT */}
      <section id="treatment-faqs" className="bg-white py-20 md:py-24">
        <div className="mx-auto max-w-3xl px-5 sm:px-6 lg:px-8">
          <div className="reveal flex items-center gap-3">
      ...
      {/* PRICING */}
      <section id="pricing-faqs" className="bg-plum-50 py-20 md:py-24">
        <div className="mx-auto max-w-3xl px-5 sm:px-6 lg:px-8">
          <div className="reveal flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-xl bg-plum-700 text-white"><Tag className="h-5 w-5" /></span>
            <h2 className="font-heading text-2xl font-bold tracking-tight text-plum-900 sm:text-3xl">Pricing</h2>
          </div>
          <div className="mt-8 flex flex-col gap-4">
            <FaqItem question="How much do treatments cost?" defaultOpen>
              Treatments range from a 15-minute head massage at $15 up to a 90-minute traditional session at $110. You'll find every option and price on the <Link href="/services#pricing" className="font-semibold text-plum-700 underline decoration-plum-300 underline-offset-2 hover:text-plum-900">full price list</Link>.
            </FaqItem>
