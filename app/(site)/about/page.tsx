...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 md:py-20 lg:px-8">
          <nav className="hero-anim text-sm text-plum-500" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2">
              ...
              <li className="font-medium text-plum-700" aria-current="page">About</li>
            </ol>
          </nav>
      ...
      {/* PHILOSOPHY */}
      <section id="philosophy" className="bg-plum-50 py-20 md:py-24">
      ...
      {/* HOW WE WORK */}
      <section id="approach" className="bg-plum-50 py-20 md:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 sm:px-6 lg:grid-cols-12 lg:gap-14 lg:px-8">
          ...
          <div className="reveal lg:col-span-6">
            <div className="rounded-2xl bg-white p-7 ring-1 ring-plum-100 sm:p-9">
              <h3 className="font-heading text-xl font-bold text-plum-800">What to know before you arrive</h3>
              <dl className="mt-6 space-y-5">
                {[
                  ...
                  <div key={dt} className="flex gap-4">
                    <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-plum-700 text-white"><Icon className="h-5 w-5" /></span>
                    <div>
                      <dt className="font-semibold text-plum-800">{dt}</dt>
                      <dd className="mt-1 text-sm leading-relaxed text-plum-700/90">{dd}</dd>
                    </div>
                  </div>
                ))}
              </dl>
      ...
      <section id="visit" className="bg-white py-20 md:py-24">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 sm:px-6 lg:grid-cols-12 lg:gap-14 lg:px-8">
          <div className="reveal lg:col-span-7">
            ...
            <ul className="mt-7 space-y-4 text-plum-800">
              <li className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-plum-500" />
                <a href={site.maps} target="_blank" rel="noopener" className="inline-flex items-center gap-1 font-medium text-plum-700 hover:text-plum-900">
                  <span className="underline decoration-plum-300 underline-offset-2">3/459 Nepean Hwy, Frankston VIC 3199</span>
                  <ArrowUpRight className="h-3.5 w-3.5 shrink-0" />
                </a>
              </li>
              <li className="flex items-start gap-3"><Phone className="mt-0.5 h-5 w-5 shrink-0 text-plum-500" /><a href={`tel:${site.phoneTel}`} className="font-medium hover:text-plum-600">{site.phoneDisplay}</a></li>
              <li className="flex items-start gap-3"><Clock className="mt-0.5 h-5 w-5 shrink-0 text-plum-500" /><span>Mon–Fri 9am–6:00pm · Sat 9am–5:00pm · Sun closed</span></li>
            </ul>
          </div>
